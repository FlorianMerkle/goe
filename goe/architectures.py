...
class SimpleViT(nn.Module):
    def __init__(self, *, image_size = 32, patch_size = 4, num_classes = 10, dim=512, depth=6, heads=8, mlp_dim=512, channels = 3, dim_head = 512):
        super().__init__()
...
# from https://github.com/huyvnphan/PyTorch_CIFAR10/blob/master/cifar10_models/mobilenetv2.py
...
def ConvMixer(dim=256, depth=16, kernel_size=8, patch_size=1, n_classes=10):
...
#from https://github.com/huyvnphan/PyTorch_CIFAR10/blob/master/cifar10_models/densenet.py
